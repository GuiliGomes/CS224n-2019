...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.decoder = nn.LSTMCell(embed_size + embed_size, hidden_size, bias=True)
        ...
        print(f'Guili: {embed_size}')
        print(f'Guili h: {hidden_size}')
    ...
    def decode(self, enc_hiddens: torch.Tensor, enc_masks: torch.Tensor,
        ...
        for Y_t in Y.split(1):
            Y_t_flat = Y_t.squeeze(dim=0)
            # print(f'Y_t_flat: {Y_t_flat}')
            # print('ˆ'*30)
            # print(f'Y_t_flat.shape: {Y_t_flat.shape}')
            # print(f'o_prev.shape: {o_prev.shape}')
            # print('ˆ'*30)
            Ybar_t = torch.cat((Y_t_flat, o_prev), dim=1)
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        # print('='*30)
        # print(f'Ybar_t.shape: {Ybar_t.shape}')
        # print(f'Dec state[0]: {dec_state[0].shape}')
        # print(f'Dec state[1]: {dec_state[1].shape}')
        dec_state = self.decoder(Ybar_t, dec_state)
        dec_hidden, dec_cell = dec_state
        # print(dec_hidden.shape)
        # print(enc_hiddens_proj.shape)
        dec_hidden_squezzed = dec_hidden.unsqueeze(dim=-1)
        # print(f'squeze: {dec_hidden_squezzed.shape}')
        e_t = torch.bmm(enc_hiddens_proj, dec_hidden_squezzed)
        e_t = e_t.squeeze()
        # print(f'e_t: {e_t.shape}')
        ...
        # print(alpha_t.shape)
        alpha_t_unsqueezed = alpha_t.unsqueeze(dim=1)
        # print(f'alpha_t_unsqueezed: {alpha_t_unsqueezed.shape}')
